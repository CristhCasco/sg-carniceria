                                ...
                                <table class="table table-bordered table striped mt-1">
                                    <thead class="text-white" style="background: #620408">
                                        <tr>
                                            ...
                                            <th class="table-th text-white text-center">TIPO PAGO</th>
                                            <th class="table-th text-white text-center">METODO PAGO</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center"><h6>{{$d->payment_type}}</h6></td>    
                                            <td class="text-center"><h6>{{$d->payment_method}}</h6></td>    
