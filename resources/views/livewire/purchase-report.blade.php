        ...
        <div class="col-sm-12">
            <div class="widget">
                <div class="widget-heading">
                    <h4 class="card-title text-center"><b>Reporte de</b></h4>
                </div>
                        ...
                        <div class="col-sm-12 col-md-3">
                            <div class="row">
                                ...
                                <div class="col-sm-12 mt-2">
                                    ...
                                    <div class="form-group">
                                        <input type="text" wire:model="dateFrom" class="form-control flatpickr" placeholder="Click para elegir" {{ $reportType == 0 ? 'disabled' : '' }}>
                                    </div>
                                </div>
                                <div class="col-sm-12 mt-2">
                                    <h6>Fecha hasta {{ $dateTo}}</h6>
                                    <div class="form-group">
                                        <input type="text" wire:model="dateTo" class="form-control flatpickr" placeholder="Click para elegir" {{ $reportType == 0 ? 'disabled' : '' }}>
                                    </div>
                                </div>
                                <div class="col-sm-12">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table striped mt-1">
                                    ...
                                    <tbody>
                                        ...
                                        @forelse($data as $d)
                                        <tr>
                                            <td class="text-center"><h6>{{number_format($d->total,0)}} Gs.</h6></td>
                                            <td class="text-center"><h6>{{$d->items}}</h6></td>                                   
                                            <td class="text-center"><h6>{{$d->status}}</h6></td>

                                            <td class="text-center"><h6>{{$d->usuario}}</h6></td> 
